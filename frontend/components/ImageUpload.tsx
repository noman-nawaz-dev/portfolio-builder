      ...
      <div className="space-y-3">
        ...
        {previewUrl && (
          <div className="relative inline-block">
            <img
              src={previewUrl}
              alt="Preview"
              className="w-full max-w-xs h-48 object-cover rounded-lg border-2 border-neutral-200"
            />
        ...
        <div className="flex items-center gap-3">
          ...
          <label
            ...
            className={`flex items-center gap-2 px-4 py-2 border-2 border-dashed border-neutral-300 rounded-lg hover:border-teal-500 hover:bg-teal-50 transition cursor-pointer ${
