  ...
  return (
    <Card padding="none" className="overflow-hidden">
      <Flex 
        justify="between" 
        align="center" 
        className="bg-neutral-800 text-white px-4 sm:px-6 py-3"
      >
        <Text weight="semibold" className="text-white text-sm sm:text-base">
          Live Preview
        </Text>
        <Text size="sm" className="text-neutral-400 text-xs sm:text-sm">
          ...
          <ThemeProvider initialTheme={theme}>
            ...
            {sections.length === 0 && (
              <Stack 
                spacing="md" 
                align="center" 
                className="p-8 sm:p-12 text-center text-neutral-400"
              >
