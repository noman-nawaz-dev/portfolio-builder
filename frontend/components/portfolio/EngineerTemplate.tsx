          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {skillsData.skills.map((skill: string, index: number) => (
                <div
                  key={index}
                  className="bg-neutral-700 px-6 py-4 rounded-lg text-center font-medium hover:bg-teal-700 transition"
                >
                  {skill}
                </div>
              ))}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {projectsData.map((project: any, index: number) => (
                <div key={index} className="bg-neutral-800 rounded-xl overflow-hidden hover:scale-105 transition">
                  {project.imageUrl && (
                    <img
      ...
      {contactData && (
        <section className="py-20 px-4 bg-neutral-800">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {contactData.email && (
                <a
                  ...
                  className="bg-teal-700 px-6 py-3 rounded-lg font-semibold hover:bg-teal-800 transition"
                >
                  Email Me
                </a>
              )}
              ...
              {contactData.github && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-neutral-700 px-6 py-3 rounded-lg font-semibold hover:bg-neutral-600 transition"
                >
                  GitHub
                </a>
              )}
            ...
            {contactData.phone && (
              <p className="text-neutral-300 mt-8 text-lg">{contactData.phone}</p>
            )}
          </div>
        </section>
      )}
